...
<div class="row">
    <div class="col-md-6">
        <h4 class="titulo-pagina mb-0">
            ...
            <small>Adicionando eleitor</small>
        </h4>
    </div>
    <div class="col-md-6">
...
<form method="post" action="/admin/eleitores/store" class="mt-5">
    ...
    <div class="row mt-4">
        <div class="col-sm-7 offset-3 text-center">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-fw"></i> Adicionar Eleitor</button>
