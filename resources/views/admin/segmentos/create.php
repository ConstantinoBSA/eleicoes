...
<div class="row">
    <div class="col-md-6">
        <h4 class="titulo-pagina mb-0">
            ...
            <small>Adicionando segmento</small>
        </h4>
    </div>
    <div class="col-md-6">
...
<form method="post" action="/admin/segmentos/store" class="mt-5">
    ...
    <div class="row mb-4">
        ...
        <div class="col-sm-7">
            <select name="status" class="form-select" id="status">
                ...
                <option value="1" <?php if (old('status') == 1) { echo 'selected'; } ?>>Ativo</option>
                <option value="0" <?php if (old('status') == 0) { echo 'selected'; } ?>>Inativo</option>
            </select>
    ...
    <div class="row mt-4">
        <div class="col-sm-7 offset-3 text-center">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-fw"></i> Adicionar Segmento</button>
