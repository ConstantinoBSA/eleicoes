...
<div class="row">
    <div class="col-md-6">
        <h4 class="titulo-pagina mb-0">
            <span><i class="fa fa-plus fa-fw"></i> Candidatos</span>
            <small>Editando candidato</small>
        </h4>
    </div>
    <div class="col-md-6">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/candidatos/index">Candidatos</a></li>
...
<form method="post" action="/admin/candidatos/update/<?php echo $candidato->id ?? '' ?>" class="mt-5">
    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? ''); ?>">

    <div class="row mb-3">
        <label for="nome" class="col-sm-3 col-form-label text-end text-muted">Nome: <span class="requerido"></span></label>
        <div class="col-sm-7">
            <input type="text" class="form-control" id="nome" name="nome" value="<?php echo htmlspecialchars($candidato->nome ?? ''); ?>">
    ...
    <div class="row mb-4">
        ...
        <div class="col-sm-7">
            <select name="status" class="form-select" id="status">
                ...
                <option value="1" <?php if (($candidato->status ?? '') == 1) {
                    echo 'selected';
                } ?>>Ativo</option>
                <option value="0" <?php if (($candidato->status ?? '') == 0) {
                    echo 'selected';
                } ?>>Inativo</option>
            </select>
    ...
    <div class="row mt-4">
        <div class="col-sm-7 offset-3 text-center">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-fw"></i> Editar Candidato</button>
            <span class="mx-1">|</span>
            <a class="btn btn-secondary" href="/admin/candidatos/index"><i class="fa fa-arrow-left fa-fw"></i> Voltar a Listagem</a>
        </div>
    </div>
</form>
<?php endSection(); ?>
